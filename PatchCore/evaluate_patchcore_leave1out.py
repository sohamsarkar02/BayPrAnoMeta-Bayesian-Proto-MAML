...
MODEL_DIR = "runs/patchcore_shared_encoder"
...
def bootstrap_metrics(scores, labels, n_bootstrap=200):
    """
    Returns mean ± standard error for AUROC, AUPRC, F1
    """
...
def main():
    ...
    save_path = f"{OUT_DIR}/patchcore_results_with_se.npy"
