#!/usr/bin/env python3
"""
Evaluation script for Federated BayPrAnoMeta: Federated Bayesian Proto-MAML
CPU friendly
"""
...
MODEL_PATH = "runs/fed_leave1out/final_model.pth"
OUT_DIR = "runs/fed_leave1out/eval"
...
def evaluate_client(model, client, pr_curves):
    ...
    # ----- PR curve (store for combined plot) -----
