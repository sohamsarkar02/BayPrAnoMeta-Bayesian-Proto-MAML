#!/usr/bin/env python3
"""
PatchCore Evaluation Script (ViSA)
Greedy Coreset Selection (25%)
...
MODEL_DIR = "runs/patchcore_visa_25pct"   
...
def evaluate_client(client):
    ...
    if not os.path.exists(memory_path):
        print(f"Missing memory bank for {client}, skipping.")
        return None
...
def main():
    ...
    save_path = f"{OUT_DIR}/patchcore_visa_25pct_results_with_se.npy"   
